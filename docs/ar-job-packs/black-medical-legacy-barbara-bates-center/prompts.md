...
Provider-agnostic AR generation job pack for `black-medical-legacy-barbara-bates-center`.
...
- Runtime targets:
  - iOS: `/models/barbara-bates-center.usdz`
  - Android: `/models/barbara-bates-center.glb`
  - Web: `/models/barbara-bates-center.glb`
...
- Historical era: 20th century nursing archives
- Style preset: `documentary`
- Visual priority: `historical_accuracy`
- Asset request: archival nursing kit; oral-history card; collection marker
...
Requested content layers: archival nursing kit, oral-history card, collection marker, hero object, plinth/base, annotation card
Fallback type: card
Negative prompt / avoid list: floating fragments, broken anatomy, abstract sculptures, futuristic materials

Asset request from catalog: archival nursing kit; oral-history card; collection marker
Producer notes: [strategy-reset] archival object scene prioritized over site-scale reconstruction
...
Primary asset request: archival nursing kit; oral-history card; collection marker
Expected runtime targets: iOS /models/barbara-bates-center.usdz, Android /models/barbara-bates-center.glb, Web /models/barbara-bates-center.glb
