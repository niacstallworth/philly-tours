# Original Bethel No. 1 Hall

Provider-agnostic AR generation job pack for `job-s-daughters-original-bethel-no-1-hall`.

## Stop Summary

- Tour: Job's Daughters
- Priority: 28
- AR Type: `historical_figure_presence`
- Asset status: `planned`
- Runtime targets:
  - iOS: `/models/original-bethel-no-1-hall.usdz`
  - Android: `/models/original-bethel-no-1-hall.glb`
  - Web: `/models/original-bethel-no-1-hall.glb`
...
- Asset request: legacy hall overlay; youth lineage cards; memory scene
...
Stop: Original Bethel No. 1 Hall
Tour: Job's Daughters
AR type: historical_figure_presence
...
Requested content layers: legacy hall overlay, youth lineage cards, memory scene, hero figure silhouette, staging marker, supporting context card
Fallback type: card
Negative prompt / avoid list: uncanny faces, caricature proportions, modern clothing, modern accessories, crowd clutter

Asset request from catalog: legacy hall overlay; youth lineage cards; memory scene
...
Primary asset request: legacy hall overlay; youth lineage cards; memory scene
Expected runtime targets: iOS /models/original-bethel-no-1-hall.usdz, Android /models/original-bethel-no-1-hall.glb, Web /models/original-bethel-no-1-hall.glb
