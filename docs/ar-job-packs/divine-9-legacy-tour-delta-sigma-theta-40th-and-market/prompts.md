...
Provider-agnostic AR generation job pack for `divine-9-legacy-tour-delta-sigma-theta-40th-and-market`.
...
- Runtime targets:
  - iOS: `/models/delta-sigma-theta-40th-and-market.usdz`
  - Android: `/models/delta-sigma-theta-40th-and-market.glb`
  - Web: `/models/delta-sigma-theta-40th-and-market.glb`
...
- Asset request: public act timeline; archival photos; chapter card
...
Stop: Delta Sigma Theta - 40th & Market
Tour: Divine 9 Legacy Tour
AR type: floating_story_card
...
Requested content layers: public act timeline, archival photos, chapter card, story card stack, headline frame, lightweight foreground treatment
Fallback type: card
Negative prompt / avoid list: busy backgrounds, unreadable layouts, overdecorated borders, dense clutter

Asset request from catalog: public act timeline; archival photos; chapter card
...
Primary asset request: public act timeline; archival photos; chapter card
Expected runtime targets: iOS /models/delta-sigma-theta-40th-and-market.usdz, Android /models/delta-sigma-theta-40th-and-market.glb, Web /models/delta-sigma-theta-40th-and-market.glb
