...
Provider-agnostic AR generation job pack for `black-american-sports-overbrook-high-school`.
...
- Runtime targets:
  - iOS: `/models/overbrook-high-school.usdz`
  - Android: `/models/overbrook-high-school.glb`
  - Web: `/models/overbrook-high-school.glb`
...
- Asset request: Wilt and Kobe legacy cards; stats overlays
...
Requested content layers: Wilt and Kobe legacy cards, stats overlays, story card stack, headline frame, lightweight foreground treatment
Fallback type: card
Negative prompt / avoid list: busy backgrounds, unreadable layouts, overdecorated borders, dense clutter

Asset request from catalog: Wilt and Kobe legacy cards; stats overlays
...
Primary asset request: Wilt and Kobe legacy cards; stats overlays
Expected runtime targets: iOS /models/overbrook-high-school.usdz, Android /models/overbrook-high-school.glb, Web /models/overbrook-high-school.glb
