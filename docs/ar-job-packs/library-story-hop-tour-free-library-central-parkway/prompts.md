# Free Library - Central Parkway

Provider-agnostic AR generation job pack for `library-story-hop-tour-free-library-central-parkway`.
...
- Runtime targets:
  - iOS: `/models/free-library-central-parkway.usdz`
  - Android: `/models/free-library-central-parkway.glb`
  - Web: `/models/free-library-central-parkway.glb`
...
- Asset request: literary quote cards; raven and book overlays; facade card
...
Stop: Free Library - Central Parkway
Tour: Library Story Hop Tour
AR type: floating_story_card
...
Requested content layers: literary quote cards, raven and book overlays, facade card, story card stack, headline frame, lightweight foreground treatment
Fallback type: card
Negative prompt / avoid list: busy backgrounds, unreadable layouts, overdecorated borders, dense clutter

Asset request from catalog: literary quote cards; raven and book overlays; facade card
...
Primary asset request: literary quote cards; raven and book overlays; facade card
Expected runtime targets: iOS /models/free-library-central-parkway.usdz, Android /models/free-library-central-parkway.glb, Web /models/free-library-central-parkway.glb
