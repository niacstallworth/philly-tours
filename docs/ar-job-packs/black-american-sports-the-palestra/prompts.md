...
Provider-agnostic AR generation job pack for `black-american-sports-the-palestra`.
...
- Runtime targets:
  - iOS: `/models/the-palestra.usdz`
  - Android: `/models/the-palestra.glb`
  - Web: `/models/the-palestra.glb`
...
- Asset request: historic game scene; score overlay; court reconstruction
...
Requested content layers: historic game scene, score overlay, court reconstruction, portal frame, foreground occlusion pass, historic depth backdrop
Fallback type: card
Negative prompt / avoid list: science fiction elements, neon cyberpunk styling, modern cars, modern glass towers, exaggerated fantasy ruins

Asset request from catalog: historic game scene; score overlay; court reconstruction
...
Primary asset request: historic game scene; score overlay; court reconstruction
Expected runtime targets: iOS /models/the-palestra.usdz, Android /models/the-palestra.glb, Web /models/the-palestra.glb
