...
window.PHILLY_TOURS_NARRATION = {
  ...
  "scriptMapByStopId": {
    ...
    "black-inventors-tour-norbert-rillieux-way": {
      "drive": "Norbert Rillieux Way is at 33rd and Walnut on the University of Pennsylvania campus — named for the man who invented the multiple-effect evaporator that revolutionized sugar refining in the 1840s and who briefly attended Penn around 1830 as one of its first Black students.",
    ...
    "college-hop-tour-drexel-university": {
      "drive": "Drexel University is at Market Street and 32nd Street in West Philadelphia — a research university founded in 1891 by Philadelphia industrialist Anthony Drexel as a technical and professional training institution that would serve students of modest means. Its Mario the Dragon mascot and Health Sciences building are landmarks of its campus.",
    ...
    "philadelphia-foundations-fair-hill-burial-ground": {
      "drive": "Fair Hill Burial Ground is at 2901 Germantown Avenue — a Quaker cemetery established in 1703 that is the resting place of Lucretia Mott, the abolitionist and suffragist, and Robert Purvis, a free Black Philadelphian who was one of the most important organizers of the Underground Railroad and a founder of the American Anti-Slavery Society.",
    ...
    "septa-broad-street-line-first-african-baptist-church": {
      "drive": "First African Baptist Church is ahead at 16th and Christian in South Philadelphia. This congregation is one of the oldest continuously operating African American Baptist churches in the United States, embedded in a neighborhood that was the institutional heart of Black Philadelphia for over a century.",
    ...
    "speakeasy-tour-andra-hem": {
      "drive": "Andra Hem is at 1333 South 2nd Street in South Philadelphia — a Nordic-themed bar with a hidden entrance behind furniture, serving Scandinavian-influenced cocktails in a space that applies the Danish and Norwegian concept of hygge — cozy, convivial warmth — to the Philadelphia bar experience.",
    ...
    "speakeasy-tour-hop-sing-laundromat": {
      "drive": "Hop Sing Laundromat is at 1029 Race Street in Chinatown — a bar entered by password, designed to evoke the laundries that served as fronts for gambling and liquor operations in Chinese American communities during the exclusion era. It has been recognized on the World's 50 Best Bars list.",
