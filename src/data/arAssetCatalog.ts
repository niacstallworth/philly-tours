...
export const arAssetCatalog: ARAssetCatalogEntry[] = [
  ...
  },
  {
    ...
    "assetStatus": "ready",
    "iosAsset": "/cards/dr-charles-drew-blood-bank.storycard",
    "androidAsset": "/cards/dr-charles-drew-blood-bank.storycard",
    "webAsset": "/cards/dr-charles-drew-blood-bank.storycard",
    "iosAssetExistsLocal": false,
    "androidAssetExistsLocal": false,
    "webAssetExistsLocal": false,
    "scale": 0.88,
    ...
    "estimatedEffort": "low",
    "notes": "[strategy-reset] switched from 3D explainer to editorial 2D story card for runtime stability",
    "stylePreset": "museum_card",
    "visualPriority": "readability",
    "historicalEra": "20th century medical innovation",
    "negativePrompt": "messy composition, abstract medical props, unreadable labels, speculative equipment detail",
    "sitePlacementMode": "default",
    "requiresProximity": false,
    "placementEnvironment": "mixed"
  },
