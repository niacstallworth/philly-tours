        ...
        return (
          <Card key={stop.id} style={styles.card}>
            ...
            <View style={styles.chips}>
              ...
              <Chip label={`Fallback: ${catalogEntry?.fallbackImageProvider || "n/a"}`} tone="default" />
              <Chip label={`Generated by: ${catalogEntry?.generatedImageProvider || "n/a"}`} tone="default" />
              <Chip label={`Style: ${catalogEntry?.stylePreset || "n/a"}`} tone="default" />
              <Chip label={`Priority: ${catalogEntry?.visualPriority || "n/a"}`} tone="default" />
            ...
            <Text style={styles.meta}>
              Concept image: {catalogEntry?.generatedImagePath || "n/a"} | Generated by {catalogEntry?.generatedImageProvider || "n/a"}
            </Text>
            <Text style={styles.meta}>
              Model routing: fal {catalogEntry?.falModel || "n/a"} | stability {catalogEntry?.stabilityEndpoint || "n/a"} | replicate {catalogEntry?.replicateModel || "n/a"}
            </Text>
            <Text style={styles.meta}>
